--[[
    Script: UI Flee The Facility (Apenas Interface)
    Autor: w_ky (UI extraída pelo Mendigo)
    Observação: Apenas a interface, funções ESP removidas
]]
...
-- Função para criar toggle (placeholders, funções vazias)
local function createToggle(parent, text, default, callback)
    ...
    button.MouseButton1Click:Connect(function()
        toggled = not toggled
        callback(toggled) -- Callback vazio por enquanto
...
-- Criar toggles (todos com funções vazias)
...
print("🚀 UI Flee v4 carregada! (Apenas interface, funções ESP removidas)")
print("📌 Ctrl Esquerdo: minimizar | Ctrl Direito: ativar ESP (placeholder)")
